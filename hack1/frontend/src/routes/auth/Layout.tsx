  ...
  return (
    <form onSubmit={onSubmit}>
      <Card className="w-sm border-none">
        ...
        <CardHeader>
          <CardTitle className="flex items-center flex-row gap-2 tracking-normal">
            ...
            <img data-testid="header-logo" className="h-5 w-5 brightness-200" src="/vscoddit.svg"
          alt="VSCoddit Logo"/>
          ...
          <div className="grid w-full items-center space-y-4">
            ...
            >
              ...
              <Input
                ...
                placeholder="Confirm Password" // Add the placeholder text
                required={location.pathname === '/register'} // Make the input required only on the registration page
